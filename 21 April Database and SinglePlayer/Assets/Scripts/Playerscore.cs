...
public class Playerscore : MonoBehaviour
{
    ...
    private void PostToDatabase()
    {
        ...
        RestClient.Put("https://infiflow-f2fab.firebaseio.com/" + playerid_signup + ".json", new_player);
        // SIGN UP SUCCESFULL GOTO MAIN MENU
    ...
    {
        RestClient.Get("https://infiflow-f2fab.firebaseio.com/" + ".json").Then(response1 =>
        {
    ...
    private void GetFromDatabase()
    {
        ...
        RestClient.Get<playerinfo>("https://infiflow-f2fab.firebaseio.com/" + playerid_login + ".json").Then(response =>
        {
